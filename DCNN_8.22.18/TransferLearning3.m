...
IMDS = imageDatastore('F:\College\Abhishek\DCNN_8.22.18\Database\','IncludeSubfolders',true,'FileExtensions','.jpg','LabelSource','foldernames'); % use imageDatastore for loading the two image categories
