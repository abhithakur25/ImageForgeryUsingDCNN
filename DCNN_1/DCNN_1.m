...
digitDatasetPath = fullfile('F:\College\Abhishek\DCNN_NEW\Database');
...
[trainDigitData,testDigitData] = splitEachLabel(digitData,.8);
...
layers = [imageInputLayer([114 114 3])
...
options = trainingOptions('sgdm','MaxEpochs',1000, ...
	...
	'InitialLearnRate',0.0001,'ExecutionEnvironment','multi-gpu','Plots','training-progress');  
% load('convnet_r008_3.mat');
...
convnet_r008_5 = trainNetwork(trainDigitData,layers,options);
save('convnet_r008_5.mat','convnet_r008_5');
%%
...
YTest = classify(convnet_r008_5,testDigitData);
